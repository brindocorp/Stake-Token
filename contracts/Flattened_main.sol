...
// File: @openzeppelin/contracts-ethereum-package/contracts/token/BEP20/IBEP20.sol
...
// File: @openzeppelin/contracts-ethereum-package/contracts/token/BEP20/BEP20Detailed.sol
 ...
 */
abstract contract BEP20Detailed is Initializable, IBEP20 {
...
// File: @openzeppelin/contracts-ethereum-package/contracts/token/BEP20/BEP20.sol
 ...
 */
contract BEP20 is Initializable, Context, IBEP20 {
 ...
 */
contract BEP20Stakes is Initializable, BEP20 {
    using SafeMath for uint256;
...
//import "@openzeppelin/contracts-ethereum-package/contracts/token/BEP20/BEP20Burnable.sol";



contract Token is Initializable, Ownable, BEP20Stakes, BEP20Detailed {
...
//        uint256 constant _annualPercent = 1; // 1%
//        uint256 constant _basePeriod = 30 seconds;
//        uint256 constant _annualPeriod = 1 day;
        BEP20Stakes.initialize(stakeBasePeriod, stakeHoldPeriod, stakeAnnualPercent, stakeAnnualPeriod);
